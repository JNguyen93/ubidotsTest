...
TOKEN = "A1E-0t7j9uczfI0uqYURnwT6u3uJ8kFWwh"  # Put your TOKEN here
...
VARIABLE_LABEL_4 = "water"
client = mqtt.Client(DEVICE_LABEL)
...
def mqttInit():
    ...
    client.publish("/v1.6/devices/demo/water", '{"value", 132}')
    
def on_connect(client, userdate, flags, rc):
    if rc == 0:
        print("Connected OK Returned code = ", rc)
    else:
        print("Bad connection Returneds code = ", rc)
